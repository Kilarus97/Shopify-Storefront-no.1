...
export const metadata: Metadata = genMeta({
  title: 'Usagi IT | Online Store',
  description: 'Discover our curated collection of products.',
  url: '/',
});
...
export default async function HomePage() {
  ...
  const webSiteJsonLd = generateWebSiteJsonLd({
    name: 'Usagi IT',
    url: 'https://shopify.usagi-it.com',
    searchUrl: 'https://shopify.usagi-it.com/search?q={search_term_string}',
  });
  
  const organizationJsonLd = generateOrganizationJsonLd({
    name: 'Usagi IT',
    url: 'https://shopify.usagi-it.com',
    logo: 'https://shopify.usagi-it.com/logo.png',
    sameAs: [
      'https://www.linkedin.com/in/mirko-zec-1b80443b5/'
    ],
  });
